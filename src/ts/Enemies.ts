...
import { MovingBox, MovingBoxHalfHitBoxes } from "./Libraries/Boxes";
...
import { Heart, Clock } from "./Items";
import { Fireball, Arrow } from "./Projectiles";
...
export class Tektite extends Enemy {
  ...
  aiThinking(): void {
    switch (this.state.get()) {
      case EnemyState.Moving:
        ...
        if (
          (this.state.currentFrame > 60 && Random.getOneInt(50)) ||
      ...
      case EnemyState.Wait:
        ...
        this.dy = 0;
        if (
          (this.state.currentFrame > 30 && Random.getOneInt(50)) ||
  ...
  customCollision(): void {
    ...
    if (
      Collisions.simpleMovingBoxLine(
        this.hitBox,
